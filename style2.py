...
benchmark_width = 800
benchmark_padding = 50
benchmark_margin = 8

def create_watermark_style2(im_target, exif, logo):
    ...
    # device
    im_white_draw.text((0, padding), device_type, fill=(0, 0, 0), font=b_font)
    # time
    im_white_draw.text((0, padding + device_type_height + margin), time, fill=(170, 170, 170), font=r_font)
    # metadata
    metadata_x = t_size[0] - metadata_width
    # line scale 线条宽度
    ...
    # metadata
    metadata_x = t_size[0] - metadata_width
    #print("logo:" ,logo_resized.size)
    #print("metadata_height:" ,metadata_height)
